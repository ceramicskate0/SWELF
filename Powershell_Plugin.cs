...
namespace SWELF
{
    class Powershell_Plugin
    {
        ...
        public static string Run_PS_Script(String PowershellSciptLocation, string PowershellSciptArgs = "")
        {
            ...
            {
                Errors.Log_Error("POSSIBLE MALWARE DETECTED", "Script located at " + powershellSciptLocation + " MD5=" + GetMD5(PowershellSciptLocation) + ". Script is Malware according to AMSI. Script Base64 Contents = " + Base64Encode(ScriptContents),Errors.LogSeverity.Critical);
                return ("POSSIBLE MALWARE DETECTED - Script located at " + powershellSciptLocation + " MD5=" + GetMD5(PowershellSciptLocation) + ". Script is Malware according to AMSI. Script Base64 Contents = " + Base64Encode(ScriptContents));
            }
        }
