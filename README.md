...
Pre-Alpha release of a simple for almost anyone windows event log forwarding agent. This mean bugs are likely and it could cause issues on a machine its run on. Currently testing on windows 10.
