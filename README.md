...
into a text file (Searchs.txt) you can find the logs you want from a windows machine and send just those to your SIEM. Thats right now all the logs just the ones you want.
