...
namespace SWELF
{
    public class Settings
    {
        ...
        public static List<string> Logs_Search_Terms_Unparsed = new List<string>();//search.txt file line by lone reads
        ...
        public static void InitializeAppSettings()
        {
            ...
            READ_Search_Terms_File(GET_SearchTermsFileName);
        ...
        public static void READ_Search_Terms_File(string LocalFilePath)
        {
            try
            {
                string line;
        ...
        /*private static void READ_Powershell_SearchTerms(string LocalFilePath, string HTTP_FilePath = "")
        {
            try
            {
                string line;
                string FileLocation;
                if (!string.IsNullOrEmpty(HTTP_FilePath))
                {
                    FileLocation = HTTP_FilePath;
                }
                else
                {
                    FileLocation = GET_SearchTermsFileName;
                }
        ...
        private static void READ_All_Plugin_Scripts_To_Run(string LocalFilePath, string HTTP_FilePath = "")
        {
...
commandline_contains:mshta -embedding
